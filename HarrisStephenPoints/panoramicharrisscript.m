...
ficheros = 'ownpictures/ownpicturef%d.jpg';
iminit = 1;
imfinal = 5;
...
panorama = zeros([alto ancho size(I,3)], 'like', I);
    ...
    I5 = imread(sprintf(ficheros, 5));
    %I6 = imread(sprintf(ficheros, 6));
    %I7 = imread(sprintf(ficheros, 7));
    %I8 = imread(sprintf(ficheros, 8));
    %I9 = imread(sprintf(ficheros, 9));
    %I10 = imread(sprintf(ficheros, 10));
    ...
    warpedImage5 = imwarp(I5, transformacion(5),'OutputView', VistaPanorama);
    %warpedImage6 = imwarp(I6, transformacion(6),'OutputView', VistaPanorama);
    %warpedImage7 = imwarp(I7, transformacion(7),'OutputView', VistaPanorama);
    %warpedImage8 = imwarp(I8, transformacion(8),'OutputView', VistaPanorama);
    %warpedImage9 = imwarp(I9, transformacion(9),'OutputView', VistaPanorama);
    %warpedImage10 = imwarp(I10, transformacion(10),'OutputView', VistaPanorama);
    ...
    panorama4= max(panorama3, warpedImage5);
    %panorama5= max(panorama4, warpedImage6);
    %panorama6= max(panorama5, warpedImage7);
    %panorama7= max(panorama6, warpedImage8);
    %panorama8= max(panorama7, warpedImage9);
    %panorama9= max(panorama8, warpedImage10);
...
% mostrar el panorama
figure; imshow(panorama4)
imwrite(panorama4, 'imagenpanorama.jpg')
